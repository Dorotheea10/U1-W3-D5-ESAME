...
/* delete me.age;
console.log("Io dopo rimozione di 'age':", me);
...
console.log("Io con array 'skills':", me);
...
console.log("Io con nuovo elemento in 'skills':", me);
...
*/
/* me.skills.pop();
console.log("Io senza l'ultimo elemento in 'skills':", me);
...
/* function whoIsBigger(num1, num2) {
  ...
  console.log("Who is Bigger:", whoIsBigger(10, 5));
...
/*  function splitMe(str) {
  ...
  console.log("Split Me:", splitMe("I love coding"));
...
/*function howManyDays(date) {
  ...
  console.log("How Many Days:", howManyDays());
...
/*function isTodayMyBirthday() {
  ...
  const birthday = new Date("10-07-1996"); // Sostituisci con la tua data di compleanno
...
console.log("Delete Prop:", deleteProp(sampleObject, "age"));

//IN CONSOLE MI ESCE IL RISULTATO ANCHE SE NON L'HO SPOSTATO
...
console.log("Count Movies:", countMovies(movies));
...
console.log("Search By Title:", searchByTitle(movies, "Lord"));
...
console.log("Remove Index:", removeIndex(movies, 2));
...
console.log("Select All TDs:", selectAllTDs());
...
console.log("Add Red Background To Links:");
